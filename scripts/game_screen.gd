...
@export var kings_node: Node #tutaj trzeba podać tego noda który trzyma wszystkich krolow


@onready var rel_bar_container: RelBarContainer = %RelBarContainer
@onready var current_supp_container: RelBarContainer = %CurrentSupportContainer
