...
var current_supp_container: RelBarContainer
...
func start_game() -> void:
    ...
    current_supp_container = scene_manager.game_screen.current_supp_container
...
func end_turn() -> void:
    ...
    current_supp_container.refresh_relationship_bars()
